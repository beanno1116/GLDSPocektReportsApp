...
const CustomerIcon = ({ size,color="rgba(255, 250, 250, 0.45)" }) => {
  return (
    
    <svg id="fi_727371" width={size} height={size} viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" fill={color}>
      <defs>
      ...
      <g>
        <g>
          <path d="M301.568,363.104l-70.272-15.296V327.04c3.68-5.312,7.104-12.096,10.656-19.136c2.656-5.248,6.656-13.184,8.32-15.072
            ...
            c8.832,0,16-7.168,16-16v-38.368C352,395.712,330.784,369.408,301.568,363.104z"></path>
        </g>
      </g>
      <g>
        <g>
          <path d="M461.568,299.104l-70.272-15.296V263.04c3.68-5.312,7.104-12.096,10.656-19.136c2.656-5.248,6.656-13.184,8.32-15.072
            ...
            c40.64,8.8,70.624,43.424,74.816,84.192H496c8.832,0,16-7.168,16-16v-38.368C512,331.712,490.784,305.408,461.568,299.104z"></path>
        </g>
      </g>
      <g>
      </g>
