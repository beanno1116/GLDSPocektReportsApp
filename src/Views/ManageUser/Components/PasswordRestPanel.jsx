  ...
  return (
    <DropdownPanel when={when}>
      <div style={{position:"absolute",left:"-25px",top:"100px",transform:"rotate(-11deg) scale(5)"}}>
          ...
          <UserLockCircleIcon size={125} color='#28304472' />
        </div>
      ...
      <FlexColumn hAlign="center" vAlign="center" p=".25rem 0 0 0">        
        <Heading size="md" mode="lite">{auth.getAuthUser().username}</Heading>
      </FlexColumn>
      <FlexRow hAlign="center">        
      </FlexRow>
      <FlexColumn flex="1" g="1rem">
        <PasswordTextField label="Current Password" {...registerFormInput("currentPassword",{required:true})} placeholder="Current password" />
