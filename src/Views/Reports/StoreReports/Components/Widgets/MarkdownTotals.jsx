...
const MarkdownTotals = ({ data,title,onClick }) => {
  ...
  return (
    <>
      <View.SectionHeader id="MarkdownTotals" m='2rem 0 .5rem 0' title={title} viewAll={onClick} action="/report/stores/sales"/>
