    ...
    <div className={`${styles.report_display_view}`}>
        ...
        <FlexColumn flex='1'>      
          ...
          <ScrollView>
            ...
            {/* <div>
              <Heading mode='light' textAlign="left">Store Stats</Heading>
              <div>
                <div style={{background:"#4DDCFF",width:"25%",height:"100px"}}></div>
              </div>
            </div> */}
            ...
            <DetailsCard title={"Safe Information"} requests={safeDetailQueries}/>
            <DetailsCard title={"Drawer Information"} requests={safeDetailQueries}/>
          ...
          {/* <div style={{position:"absolute",display:"flex",flexDirection:"column",gap:"1rem",width:"100%",height:"100%",padding:"0 1rem 1rem 1rem",overflowY:"scroll",background:"red"}}>
