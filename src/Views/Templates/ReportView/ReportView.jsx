...
import StoreBalanceIcon from '../../../assets/icons/Color/StoreBalanceIcon';
import FlexRow from '../../../Components/FlexComponents/FlexRow';
import Heading from '../../../Components/Labels/Heading';
import InputLabel from '../../../Components/Labels/InputLabel';
import styles from './reportView.module.css';

const ReportRow = ({title,group,reports=[],onClick}) => {
  return (
    <div className={styles.report_view_row_tmplate}>
      ...
      <div className={styles.report_button_row}>
        ...
        <div style={{position:"absolute",width:"100%",height:"100%",overflowX:"scroll",whiteSpace:" nowrap"}}>
          ...
          {reports.map(report => {
            return (
              <div data-group={title} data-report={report.title} className={`${styles.report_button}`} onClick={onClick}>
